# Install Wordpress on oracle always free VM

## Set up VM
![alt screenshot oracle cloud login](/images/oracle_cloud_login.pngimage.png)

on oracle cloud

### Get Keys (public and private), username, IP
on Oracle cloud
...
The Software that manages the Containers.
...
Which will help orchestrate the three containers.



## Description

cat /etc/*-release check unix flavour
